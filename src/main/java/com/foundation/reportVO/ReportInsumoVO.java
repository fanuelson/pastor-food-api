...
@ReportTemplateModel(templatePath = Constants.REPORTS_DIR + "/insumo/relatorioInsumos.jasper", isTemplateUnderResource = false)
public class ReportInsumoVO extends AbstractReportVO {
	...
	private String subReportDir = Constants.REPORTS_DIR + "/insumo";
